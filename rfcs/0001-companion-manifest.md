...
1. **Reference, don't fork.** `shadcnItem` points at the canonical shadcn registry-item URL plus a SHA-256 digest. The shadcn document remains the install payload.
